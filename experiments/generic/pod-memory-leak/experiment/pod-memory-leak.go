...
import (
	litmusLIB "github.com/litmuschaos/litmus-go/chaoslib/litmus/pod-memory-leak/lib"
...
// PodMemoryLeak injects the pod-memory-leak chaos
func PodMemoryLeak(clients clients.ClientSets) {
	...
	if err := result.ChaosResult(&chaosDetails, clients, &resultDetails, "SOT"); err != nil {
		...
		failStep := "Updating the chaos result of pod-memory-leak experiment (SOT)"
	...
	log.InfoWithValues("[Info]: The application information is as follows", logrus.Fields{
		...
		"Target Memory Consumption": experimentsDetails.TargetMemoryConsumption,
	})
